...
fun solvePartOne(dirs: Map<String, Int>): Int = dirs.values.filter { it <= 100_000 }.sum()
...
fun Path.isRoot(): Boolean = peek() == separator

fun Path.absolute(): String = if (isRoot()) separator else toList().joinToString(separator).drop(1)
