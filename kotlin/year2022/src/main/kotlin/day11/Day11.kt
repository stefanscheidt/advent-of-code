...
fun List<Monkey>.lowestCommonTest(): Long =
    map { it.test }.reduce(Long::times)

fun List<Monkey>.business(): Long {
    val (inspections1, inspection2) = sortedByDescending { it.inspections }.map { it.inspections }.take(2)
